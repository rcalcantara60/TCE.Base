...
namespace TCE.DomainLayerBase.Base
{
    public abstract class HttpClientServiceBase<TEntity> : ServiceBase<TEntity>, IHttpClientServiceBase<TEntity> where TEntity : class
    {
        ...
        public HttpClientServiceBase(string apiName, IEFRepositoryBase<TEntity> repository, IMicroORMBaseRepository<TEntity> repositoryMicroOrm) : base(repository, repositoryMicroOrm)
        {
